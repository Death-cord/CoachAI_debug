...
namespace bw
{
    ...
    const offset<uint16_t *> map_tile_ids = 0x005993C4; //bwapi call it MapTileArray (MTXM)
    const offset<uint32_t*> map_tile_flags = 0x006D1260; //bwapi call it ActiveTileArray
