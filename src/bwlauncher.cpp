...
extern "C" __declspec(dllexport) BOOL ApplyPatchSuspended(HANDLE process, DWORD process_id)
{
    return InjectToProcess(process);
}

/// Bwlauncher plugin post window creation hook
extern "C" __declspec(dllexport) BOOL ApplyPatch(HANDLE process, DWORD process_id)
{
    return TRUE;
}
...
extern "C" __declspec(dllexport) void GetData(char *name, char *description, char *url)
{
    // How large are these buffers??
    strcpy(name, "CoachAI-debug");
    strcpy(description, "Moataz's fork of Neive's AI_debug:\thttps://github.com/neivv/ai_debug_1161\r\n\r\n================================\r\n            An in-game console from your dreams.\r\n================================\r\n\r\nMagical SC1 things you've never did/seen, press ~ to toggle it.\r\n\r\nHow to:\r\nhttps://github.com/captain-majid/BWAPI-Revamped");
    strcpy(url, "https://github.com/captain-majid/BWAPI-Revamped");
}
